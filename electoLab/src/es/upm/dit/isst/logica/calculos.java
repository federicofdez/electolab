...
public class calculos {
	 ...
	 { //Nombre, identificado, comunidad autónoma, escaños, electores
	     provincias.add(new Provincia("Álava","alava","País Vasco",248456));
	     provincias.add(new Provincia("Albacete","albacete","Castilla La Mancha",304089));
	     provincias.add(new Provincia("Alicante","alicante","Comunidad Valenciana",1220005));
	     provincias.add(new Provincia("Almería","almeria","Andalucía",452589));
	     provincias.add(new Provincia("Asturias","asturias","Asturias",876171));
	     provincias.add(new Provincia("Ávila","avila","Castilla León",132575));
	     provincias.add(new Provincia("Badajoz","badajoz","Extremadura",548707));
	     provincias.add(new Provincia("Barcelona","barcelona","Cataluña",3974408));
	     provincias.add(new Provincia("Burgos","burgos","Castilla León",284916));
	     provincias.add(new Provincia("Cáceres","caceres","Extremadura",335845));
	     provincias.add(new Provincia("Cádiz","cadiz","Andalucía",968097));
	     provincias.add(new Provincia("Cantabria","cantabria","Cantabría",464081));
	     provincias.add(new Provincia("Castellón","castellon","Comunidad Valenciana",409474));
	     provincias.add(new Provincia("Ceuta","ceuta","Ceuta",59213));
	     provincias.add(new Provincia("Ciudad Real","ciudadreal","Castilla La Mancha",396293));
	     provincias.add(new Provincia("Córdoba","cordoba","Andalucía",635086));
	     provincias.add(new Provincia("Cuenca","cuenca","Castilla La Mancha",156088));
	     provincias.add(new Provincia("Gerona","gerona","Cataluña",496127));
	     provincias.add(new Provincia("Granada","granada","Andalucía",702887));
	     provincias.add(new Provincia("Guadalajara","guadalajara","Castilla La Mancha",178749));
	     provincias.add(new Provincia("Guipúzcoa","guipuzcoa","País Vasco",555417));
	     provincias.add(new Provincia("Huelva","huelva","Andalucía",389811));
	     provincias.add(new Provincia("Huesca","huesca","Aragón",167331));
	     provincias.add(new Provincia("Islas Baleares","islasbaleares","Islas Baleares",748577));
	     provincias.add(new Provincia("Jaén","jaen","Andalucía",522173));
	     provincias.add(new Provincia("La Coruña","lacoruña","Galicia",936602));
	     provincias.add(new Provincia("La Rioja","larioja","La Rioja",233087));
	     provincias.add(new Provincia("Las Palmas","laspalmas","Islas Canarias",798145));
	     provincias.add(new Provincia("León","leon","Castilla León",398416));
	     provincias.add(new Provincia("Lérida","lerida","Cataluña",299069));
	     provincias.add(new Provincia("Lugo","lugo","Galicia",286315));
	     provincias.add(new Provincia("Madrid","madrid","Comunidad de Madrid",4658397));
	     provincias.add(new Provincia("Málaga","malaga","Andalucía",1113952));
	     provincias.add(new Provincia("Melilla","melilla","Melilla",53257));
	     provincias.add(new Provincia("Murcia","murcia","Murcia",1003799));
	     provincias.add(new Provincia("Navarra","navarra","Navarra",478330));
	     provincias.add(new Provincia("Orense","orense","Galicia",267704));
	     provincias.add(new Provincia("Palencia","palencia","Castilla León",137517));
	     provincias.add(new Provincia("Pontevedra","pontevedra","Galicia",774937));
	     provincias.add(new Provincia("Santa Cruz de Tenerife","tenerife","Islas Canarias",280762));
	     provincias.add(new Provincia("Salamanca","salamanca","Castilla León",733362));
	     provincias.add(new Provincia("Segovia","segovia","Castilla León",118502));
	     provincias.add(new Provincia("Sevilla","sevilla","Andalucía",1501271));
	     provincias.add(new Provincia("Soria","soria","Castilla León",70718));
	     provincias.add(new Provincia("Tarragona","tarragona","Cataluña",547971));
	     provincias.add(new Provincia("Teruel","teruel","Aragón",105453));
	     provincias.add(new Provincia("Toledo","toledo","Castilla La Mancha",509333));
	     provincias.add(new Provincia("Valencia","valencia","Valencia",1893225));
	     provincias.add(new Provincia("Valladolid","valladolid","Castilla León",421369));
	     provincias.add(new Provincia("Vizcaya","vizcaya","País Vasco",913244));
	     provincias.add(new Provincia("Zamora","zamora","Castilla León",155512));
	     provincias.add(new Provincia("Zaragoza","zaragoza","Aragón",714370));
