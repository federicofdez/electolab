...
public class initServlet extends HttpServlet {
	...
	public void init(){
		...
		if(!dao.exist_escenario("admin")){
			...
			dao.create_escenario("admin", votos, provincias, partidos, comentarios, Sistema.DHONDT, Circunscripciones.PROVINCIAS, 176);
